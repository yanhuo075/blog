...
![告警活动状态](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250807165555259.png) 
...
![告警规则](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250807165646627.png)

​                                                                                           告警规则

切换到Alerts标签http://127.0.0.1:9090/alerts可以查看当前告警的活动状态。

![告警活动状态](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250807165720966.png)                        
...
![img](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250807165917532.png)

Prometheus首次检测到满足触发条件后，hostCpuUsageAlert显示由一条告警处于活动状态。由于告警规则中设置了1m的等待时间，当前告警状态为PENDING，如下图所示：

![img](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250807165954606.png)

如果1分钟后告警条件持续满足，则会实际触发告警并且告警状态为FIRING，如下图所示：

![img](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250807170029148.png)
