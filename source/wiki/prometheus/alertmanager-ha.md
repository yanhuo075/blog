...
![Alertmanager成为单点](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808102300170.png)Alertmanager成为单点
...
![Alertmanager特性](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808102326052.png)Alertmanager特性
...
![img](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808102356423.png)
...
![Alertmanager Gossip](https://prometheus.wang/ha/static/prom-ha-with-am-gossip.png)Alertmanager Gossip

## Gossip协议

Gossip是分布式系统中被广泛使用的协议，用于实现分布式节点之间的信息交换和状态同步。Gossip协议同步状态类似于流言或者病毒的传播，如下所示：

![Gossip分布式协议](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808102442039.png)Gossip分布式协议
...
![通知流水线](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808102523442.png)通知流水线
...
![Gossip机制](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808102558024.png)Gossip机制
...
![Alertmanager HA部署结构](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808102635353.png)Alertmanager HA部署结构
...
![Alertmanager集群状态](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808102707623.png)Alertmanager集群状态
...
![Promthues与Alertmanager HA部署结构](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808102741915.png)Promthues与Alertmanager HA部署结构
