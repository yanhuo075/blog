...
![通过增长率表示样本的变化情况](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250807163129426.png)通过增长率表示样本的变化情况
...
![获取分布直方图的中位数](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250807163205999.png)获取分布直方图的中位数
