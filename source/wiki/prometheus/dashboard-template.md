...
![主机CPU使用率](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808094841460.png)主机CPU使用率
...
![Dashboard变量](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808094942559.png)Dashboard变量
...
![为Dashboard添加变量](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808095018799.png)为Dashboard添加变量
...
![新建Query类型的变量](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808095047748.png)新建Query类型的变量
...
![在Metrics中使用变量](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808095125406.png)在Metrics中使用变量
...
在grafana中配置如图： ![Grafana中动态修改变量](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808095257524.png)
...
![Prometheus采集任务状态](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808095339898.png)Prometheus采集任务状态

如下所示，这里为Dashboard定义了一遍名为job的变量：

![使用变量获取当前所有可选任务](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808095405735.png)使用变量获取当前所有可选任务
...
![General中的Repeat选项](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808095438201.png)General中的Repeat选项
...
![在Metric中使用变量](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808095506365.png)在Metric中使用变量

而如果还希望能够自动生成Row，只需要在Row的设置中，选择需要Repeat的变量即可：

![Repeat Row](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808095541679.png)Repeat Row
