...
![Graph面板](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808092209167.png)Graph面板
...
![Prometheus Counter可视化](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808092244063.png)Prometheus Counter可视化

在**Metrics选项**中，我们使用以下PromQL定义如何从Prometheus中读取数据：
...
![Metrics选项](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808092316653.png)Metrics选项
...
![使用Legend format模板化图例](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808092344021.png)使用Legend format模板化图例

由于当前使用的PromQL的数据范围为0~1表示CPU的使用率，为了能够更有效的表达出度量单位的概念，我们需要对Graph图表的坐标轴显示进行优化。如下所示，在**Axes选项**中可以控制图标的X轴和Y轴相关的行为：

![Axes选项](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808092421581.png)Axes选项
...
![Legend选项](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808092559427.png)Legend选项

**Options中**可以设置图例的显示方式以及展示位置，**Values**中可以设置是否显示当前时间序列的最小值，平均值等。 **Decimals**用于配置这些值显示时保留的小数位，如下所示：

![Legend控制图例的显示示例](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808092650806.png)Legend控制图例的显示示例
...
![Display选项](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808092718008.png)Display选项
...
![Series overrides](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808092803191.png)Series overrides

这里定义了一条自定义规则，其匹配图例名称满足**/localhost/**的时间序列，并定义其以点的形式显示在图表中，修改后的图标显示效果如下：

![Series overrides效果](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808092834485.png)Series overrides效果

Display选项中的最后一个是**Thresholds**，Threshold主要用于一些自定义一些样本的阈值，例如，定义一个Threshold规则，如果CPU超过50%的区域显示为warning状态，可以添加如下配置：

![Threshold设置](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808092908282.png)Threshold设置
...
![Metrics设置](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808092951055.png)Metrics设置

Graph面板重新计算了Bucket边界，如下所示，在0~1ms范围内的任务次数为2，在1~2ms范围内的运行任务次数为34。通过图形的面积，可以反映出各个Bucket下的大致数据分布情况：

![Histogram数据可视化](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808093015867.png)Histogram数据可视化
