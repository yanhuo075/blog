...
![创建静默规则](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250807173602089.png)
...
![活动的静默规则](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250807173506020.png)活动的静默规则

当静默规则生效以后，从Alertmanager的Alerts页面下用户将不会看到该规则匹配到的告警信息。

![告警信息](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250807173539682.png)
