...
![SingleStat Panel示例](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808094049184.png)SingleStat Panel示例

## 使用SingleStat Panel

从Dashboardc创建Singlestat Panel，并进入编辑页面， 如下所示：

![SingleStat 编辑页面](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808094130271.png)SingleStat 编辑页面
...
![SingleStat Option选项](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808094204675.png)SingleStat Option选项
...
![Singlestat value mappings配置](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808094242322.png)Singlestat value mappings配置
...
![在Singlestat中使用Emoji表情字符](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808094350717.png)
