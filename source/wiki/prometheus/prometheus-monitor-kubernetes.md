...
title: 9.5 Prometheus监控Kubernetes集群
order: 52
---
...
![直接采集kubelet监控指标](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808111504657.png)直接采集kubelet监控指标
...
![通过api-server代理获取kubelet监控指标](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808111536809.png)通过api-server代理获取kubelet监控指标
...
![99%的Pod启动时间](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808111607649.png)99%的Pod启动时间
...
![Pod平均启动时间](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808111637911.png)Pod平均启动时间
...
![直接访问kubelet](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808111732710.png)直接访问kubelet
...
![使用api-server代理](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808111759091.png)使用api-server代理
...
![通过Pod模式自动发现Node Exporter实例](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808111828561.png)通过Pod模式自动发现Node Exporter实例
...
![Service负载均衡](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808111855405.png)Service负载均衡
...
![apiserver任务状态](https://fastly.jsdelivr.net/gh/yanhuo075/images-repo/upload/20250808111922983.png)apiserver任务状态
